   ...
   --}}
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facere voluptatum sint adipisci laboriosam, obcaecati mollitia iure corporis error voluptates praesentium?</p>
      </div>
    </main>
  </div>
